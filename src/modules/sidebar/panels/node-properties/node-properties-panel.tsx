...
import { AttributesManagementPanel } from '~/modules/sidebar/panels/attributes-management';
...
export function NodePropertiesPanel() {
  ...
  return (
    <SidebarPanelWrapper>
      <SplitPane
        sizes={paneSizes}
        sashRender={() => <div className="bg-dark-300 h-0.5 transition hover:(scale-y-200 bg-teal-800/50)" />}
